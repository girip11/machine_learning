...
#  Default: ''
c.ServerApp.browser = '/usr/bin/google-chrome'
...
#  Choices: any of ['blake2s', 'sha256', 'sha3_512', 'sha384', 'sha224', 'blake2b', 'sha512', 'sha3_224', 'md5', 'sha3_256', 'sha1', 'sha3_384']
#  Default: 'sha256'
